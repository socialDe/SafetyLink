    ...
    class ControlAsync extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            if (s.equals("notExist")) {
                Toast.makeText(CarAddActivity.this, "등록된 차량번호가 아닙니다.", Toast.LENGTH_SHORT).show();

            } else if (s.equals("alreadyExist")) {
                Toast.makeText(CarAddActivity.this, "이미 등록된 차량번호 입니다.", Toast.LENGTH_SHORT).show();

            } else {
                final EditText edittext = new EditText(CarAddActivity.this);
                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(CarAddActivity.this);
                alertDialog.setTitle("인증번호")
                        ...
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (edittext.getText().toString().equals(number + "")) {
                                    ...
                                    Toast.makeText(CarAddActivity.this, "번호가 틀렸습니다", Toast.LENGTH_SHORT).show();
                                }
                            }
                        })
                        .setNegativeButton("취소", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(CarAddActivity.this, "취소되었습니다", Toast.LENGTH_SHORT).show();
                            }
                        });
...
//        }
    ...
    class HttpAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            progressDialog = new ProgressDialog(CarAddActivity.this);
