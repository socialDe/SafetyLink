...
public class TruckFuncSetActivity extends AppCompatActivity {
    CarVO nowCar;
    String userId;
    UsersVO user;
    TextView textView_carName, textView_carModel, textView_carNum;
    ImageButton imageButton_fcm, imageButton_acc, imageButton_sleep, imageButton_drop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_truck_func_set);
        ...
        imageButton_drop = findViewById(R.id.imageButton_drop);
        ...
        imageButton_drop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UsersVO userRequest = user;
                if(userRequest.getDroppushcheck().equals("o")){
                    String event = "drop";
                    String value = "f";
                    changeFuncSet(event, value);
                    user.setDroppushcheck("f");
                    imageButton_drop.setImageResource(R.drawable.icon5);

                }else if(userRequest.getDroppushcheck().equals("f")){
                    String event = "drop";
                    String value = "o";
                    changeFuncSet(event, value);
                    user.setDroppushcheck("o");
                    imageButton_drop.setImageResource(R.drawable.icon5_g);
                }
            }
        });
    ...
    public void setFuncSetImageButton(String userSubject, String accPushCheck, String sleepPushCheck, String dropPushCheck){
        ...
        if(dropPushCheck.equals("o")){
            imageButton_drop.setImageResource(R.drawable.icon5_g);
        }else if(dropPushCheck.equals("f")){
            imageButton_drop.setImageResource(R.drawable.icon5);
        }
    }
    ...
    class SetInfoAsyncTask extends AsyncTask<String,String,String> {
        ...
        @Override
        protected void onPreExecute() {
            progressDialog = new ProgressDialog(TruckFuncSetActivity.this);
...
//            return POST(urls[0], userData);
        ...
        protected void onPostExecute(String s) {
            ...
            if (result.equals("fail")) {
                // LOGIN FAIL
                AlertDialog.Builder dailog = new AlertDialog.Builder(TruckFuncSetActivity.this);
                ...
                try {
                    ...
                    setFuncSetImageButton(usersubject, accpushcheck, sleeppushcheck, droppushcheck);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
