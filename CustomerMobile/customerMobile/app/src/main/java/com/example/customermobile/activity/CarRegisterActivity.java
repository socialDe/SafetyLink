...
public class CarRegisterActivity extends AppCompatActivity {
    ...
    public void SendNumberFcm(String carnum, int number) {
        String urlstr = "http://192.168.0.60/webServer/sendnumberfcm.mc";
    ...
    public void bt_register(View v){
        ...
        url += "?userid="+user.getUserid()+"&carnum=" + carnum + "&carmodel=" + carmodel + "&cartype=" + cartype + "&caryear=" + caryear + "&fueltype=" + fueltype;
