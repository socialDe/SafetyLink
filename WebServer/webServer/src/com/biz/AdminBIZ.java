...
@Service("abiz")
public class AdminBIZ implements Biz<String, String, AdminVO> {

	@Resource(name="adao")
	Dao<String, String, AdminVO> dao;
	...
	@Override
	public AdminVO getFromKeys(String k1, String k2) throws Exception {
