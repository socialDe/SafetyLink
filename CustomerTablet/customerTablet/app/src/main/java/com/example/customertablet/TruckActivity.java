...
//                            smsManager.sendTextMessage("tel:010-9316-3163", null, "충돌 사고 발생", null, null);
                                _runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(TruckActivity.this, "119에 신고 되었습니다!", Toast.LENGTH_LONG).show();
                                    }
                                });
                    ...
                    if (droppushcheck.equals("o")) {
                        ...
                        if (input.getContents().substring(4, 8).equals("0005")) {
                            ...
                            if (loadData.substring(0, 1).equals("9")) {
                                ...
                                textView_freight.setText(initialLoad);
                                    ...
                                    if (initialLoad > avgLoad + 500) {
                                        ...
                                        if (dialogLoad == 1) {
                                            ...
                                            _runOnUiThread(new Runnable() {
                                                @Override
                                                public void run() {
                                                    android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(TruckActivity.this);
    ...
    class HttpAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (result.equals("crush")) {
                AlertDialog.Builder dailog = new AlertDialog.Builder(TruckActivity.this);
  ...
  /*
    ...
    class Tire extends Thread {
        ...
        public void run() {
            ...
            if (e <= 5) {
                bundle.putInt("rrtire2", 1);
                msg.setData(bundle);
            } else if (e <= 30 && e > 5) {
                bundle.putInt("rrtire2", 2);
                msg.setData(bundle);
            } else if (e <= 100) {
                bundle.putInt("rrtire2", 3);
                msg.setData(bundle);
            }
            if (f <= 5) {
                bundle.putInt("rrtire3", 1);
                msg.setData(bundle);
            } else if (f <= 30 && f > 5) {
                bundle.putInt("rrtire3", 2);
                msg.setData(bundle);
            } else if (f <= 100) {
                bundle.putInt("rrtire3", 3);
                msg.setData(bundle);
            }
    ...
    class TireHandler extends Handler {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            final int rl2 = bundle.getInt("rrtire2");
            final int rl3 = bundle.getInt("rrtire3");
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    if (fl == 1) {
                    ...
                    if (rl2 == 1) {
                        imageView_rltire2.setImageResource(R.drawable.redcircle);
                    } else if (rl2 == 2) {
                        imageView_rltire2.setImageResource(R.drawable.orangecircle);
                    } else if (rl2 == 3) {
                        imageView_rltire2.setImageResource(R.drawable.greencircle);
                    }
                    if (rl3 == 1) {
                        imageView_rltire3.setImageResource(R.drawable.redcircle);
                    } else if (rl3 == 2) {
                        imageView_rltire3.setImageResource(R.drawable.orangecircle);
                    } else if (rl3 == 3) {
                        imageView_rltire3.setImageResource(R.drawable.greencircle);
                    }
                }
            });
